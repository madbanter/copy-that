...
- [ ] **Configuration Search**: Automatically search for configuration files in standard locations (e.g., `~/.config/copy-that/config.yaml`).
- [ ] **Shell Completions**: Generate shell completion scripts for `bash`, `zsh`, and `fish`.
